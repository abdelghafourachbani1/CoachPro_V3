...
<div class="hero">
    ...
    <?php if (!Session::isAuthenticated()): ?>
        <div class="hero-buttons">
            <a href="/sport-mvc/public/index.php?url=auth/register" class="btn btn-primary">S'inscrire</a>
            <a href="/sport-mvc/public/index.php?url=auth/login" class="btn btn-secondary">Se connecter</a>
        </div>
    <?php endif; ?>
</div>
...
### Ajouter le CSS pour la page d'accueil dans `style.css`
```css
/* Hero section */
